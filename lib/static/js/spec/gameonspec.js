describe("gameon", function () {
    ...
    it("should be able to play music (looping)", function (done) {
        gameon.loadSound("music", '/lib/static/music/ws-theme.mp3');
    ...
    it("should be able to play sounds", function (done) {
        gameon.loadSound("sound", '/lib/static/music/doublepoints.m4a');
...
//            clock = new lib.clock(gameOver, seconds);
//        });
//
//        afterEach(function () {
...
//            }
//
//            var clock2 = new lib.clock(gameOver, seconds);
//
//            clock2.start();
