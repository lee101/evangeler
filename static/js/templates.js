...
output += "\n            ";
frame = frame.push();
var t_7 = runtime.memberLookup((t_4),"contests", env.autoesc);
if(t_7) {for(var t_5=0; t_5 < t_7.length; t_5++) {
var t_8 = t_7[t_5];
frame.set("contest", t_8);
output += "\n                ";
var t_9;
t_9 = "/contests/" + runtime.memberLookup((t_8),"uid", env.autoesc) + "/" + runtime.memberLookup((t_8),"url_title", env.autoesc);
frame.set("link", t_9);
if(!frame.parent) {
context.setVariable("link", t_9);
context.addExport("link");
}
output += "\n                ";
if(runtime.memberLookup((t_8),"status", env.autoesc) == runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "fixtures")),"STATUS", env.autoesc)),"DRAFT", env.autoesc)) {
output += "\n                    ";
t_9 = "/contests/" + runtime.memberLookup((t_8),"uid", env.autoesc) + "/" + runtime.memberLookup((t_8),"url_title", env.autoesc) + "/edit";
frame.set("link", t_9);
if(!frame.parent) {
context.setVariable("link", t_9);
context.addExport("link");
...
if(runtime.memberLookup((t_8),"status", env.autoesc) == runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "fixtures")),"STATUS", env.autoesc)),"LIVE", env.autoesc)) {
output += "\n                                    <span class=\"label label-success\">Live</span>\n                                ";
;
}
else {
if(runtime.memberLookup((t_8),"status", env.autoesc) == runtime.memberLookup((runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "fixtures")),"STATUS", env.autoesc)),"FINISHED", env.autoesc)) {
...
output += runtime.suppressValue(runtime.memberLookup((t_8),"title", env.autoesc), env.autoesc);
output += "</a>\n\n                                <p class=\"text-smaller\">";
output += runtime.suppressValue(runtime.memberLookup((t_8),"about", env.autoesc), env.autoesc);
output += "</p>\n                                ";
if(runtime.contextOrFrameLookup(context, frame, "showEditButtons")) {
output += "\n                                    <a class=\"btn\" href=\"/contests/";
output += runtime.suppressValue(runtime.memberLookup((t_8),"uid", env.autoesc), env.autoesc);
output += "/";
output += runtime.suppressValue(runtime.memberLookup((t_8),"url_title", env.autoesc), env.autoesc);
output += "\"\n                                       title=\"View ";
...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"title", env.autoesc), env.autoesc);
output += "\">\n                        </div>\n\n                        <div class=\"form-group\">\n                            <label for=\"contestAbout\" class=\"sr-only\">About</label>\n                            <textarea id=\"contestAbout\" class=\"text-smaller form-control\"\n                                      rows=\"4\" name=\"about\"\n                                      placeholder=\"Dunkin' Donuts is giving away free donuts for life! Share this, get the most likes on your share and you'll be rolling in a lifetime supply of delicious Dunkin' Donuts delivered to your door!\"\n                                    >";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"about", env.autoesc), env.autoesc);
output += "</textarea>\n\n                        </div>\n\n                        <div class=\"form-group\">\n                            <label for=\"contestDescription\">Description</label>\n                            <textarea id=\"contestDescription\" class=\"text-smaller form-control\"\n                                      rows=\"8\" name=\"description\"\n                                      placeholder=\"For 1st place Dunkin' Donuts is giving away free donuts for life! People in 2nd and 3rd place will win a $100 Dunkin' Donuts Delicious Donut card! The winner will get the coveted Dunkin' Donuts free donuts card, use it in stores and you can get up to 5 free donuts a day!\"\n                                    >";
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"description", env.autoesc), env.autoesc);
...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"tagsString", env.autoesc), env.autoesc);
...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"duration", env.autoesc) || 12, env.autoesc);
...
output += "\" ";
if(runtime.memberLookup((t_4),"page_id", env.autoesc) == runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentCompany")),"page_id", env.autoesc)) {
...
output += runtime.suppressValue(runtime.memberLookup((runtime.contextOrFrameLookup(context, frame, "currentContest")),"website_link", env.autoesc), env.autoesc);
output += "\">\n\n                                </div>\n                            </div>\n                        </div>\n\n                        ";
if(runtime.contextOrFrameLookup(context, frame, "creating")) {
